...
$title = getCollectionName($objConnection, $uri[1]);
?>
    ...
    <div id="home">
        <section id="content">
            <div id="productMargin">
                ...
                <p id="contentDescription">Check out all categories in this collection.</p>

                <div id="productWrapper">
                    <?php

                    $result = getCategoriesByCollection($objConnection, $uri[1]);

                    while($row = $result->fetch_object()) {
                        echo "<a href='$http/products/$row->gender/$row->idCategories'>";
                        echo "<div>";
                        echo "<img src='$http/images/categories/$row->categoryImage' alt='$row->categoryAlt'>";
                        $gender = ucfirst($row->gender) . "'s ";
                        echo "<p>$gender $row->categoryName</p>";
                        echo "<p>More ></p>";
                        echo "</div>";
                        echo "</a>";
                    }
